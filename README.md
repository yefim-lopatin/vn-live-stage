...
- В активном режиме интерфейс Foundry скрывается, игроки располагаются слева, NPC — справа, а кадр оформляется кинополосами.
- Игрок или GM удерживает кнопку **«Говорю»**: микрофон не включается, выбранный портрет только возвращается к естественной яркости.
- GM выбирает свой говорящий портрет в пульте, может отражать изображения по горизонтали и добавлять игроков из аватаров назначенных персонажей.
